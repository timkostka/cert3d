...
class AnalysisWindowBase ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.menu_file_open = wx.MenuItem( self.menu_file, wx.ID_OPEN, u"&Open"+ u"\t" + u"Ctrl+O", wx.EmptyString, wx.ITEM_NORMAL )
        self.menu_file_open.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_FILE_OPEN,  ) )
        self.menu_file.Append( self.menu_file_open )

        self.menu_file.AppendSeparator()

        self.menu_file_exit = wx.MenuItem( self.menu_file, wx.ID_EXIT, u"E&xit"+ u"\t" + u"Alt+F4", wx.EmptyString, wx.ITEM_NORMAL )
        ...
        bSizer22.Add( self.scope_panel, 1, wx.ALL|wx.EXPAND, 5 )


        self.panel_viewer.SetSizer( bSizer22 )
        self.panel_viewer.Layout()
        bSizer22.Fit( self.panel_viewer )
        self.notebook.AddPage( self.panel_viewer, u"Data viewer", False )
        self.panel_test_runner = wx.Panel( self.notebook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
        ...
        sbSizer6 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel3, wx.ID_ANY, u"Test progress" ), wx.VERTICAL )

        self.checkbox_view_when_complete = wx.CheckBox( sbSizer6.GetStaticBox(), wx.ID_ANY, u"Automatically view when done", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.checkbox_view_when_complete.SetValue(True)
        sbSizer6.Add( self.checkbox_view_when_complete, 0, wx.ALL, 5 )

        self.gauge_test_progress = wx.Gauge( sbSizer6.GetStaticBox(), wx.ID_ANY, 100, wx.DefaultPosition, wx.DefaultSize, wx.GA_HORIZONTAL )
        ...
        self.button_run_test = wx.Button( self.m_panel5, wx.ID_ANY, u"Run Test", wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer8.Add( self.button_run_test, 0, wx.ALL, 5 )


        bSizer8.Add( ( 0, 0), 1, wx.EXPAND, 5 )

        self.button_view_results = wx.Button( self.m_panel5, wx.ID_ANY, u"View", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_splitter1 = wx.SplitterWindow( self.panel_test_runner, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.SP_3D|wx.SP_LIVE_UPDATE )
        ...
        sbSizer2 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel4, wx.ID_ANY, u"Test G-code" ), wx.VERTICAL )

        bSizer13 = wx.BoxSizer( wx.HORIZONTAL )

        self.button_create_update = wx.Button( sbSizer2.GetStaticBox(), wx.ID_ANY, u"Create/Update", wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT )
        bSizer13.Add( self.button_create_update, 0, 0, 5 )

        self.button_delete = wx.Button( sbSizer2.GetStaticBox(), wx.ID_ANY, u"Delete", wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT )
        ...
        self.combo_box_test_choice = wx.ComboBox( sbSizer2.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, combo_box_test_choiceChoices, 0 )
        sbSizer2.Add( self.combo_box_test_choice, 0, wx.EXPAND|wx.TOP, 5 )

        self.text_ctrl_test_code = wx.TextCtrl( sbSizer2.GetStaticBox(), wx.ID_ANY, u"G21 ; set units to mm\nG90 ; set mode to absolute\nM92 X80 Y80 Z4000 E500 ; set steps/mm\nM203 X160 Y160 Z50 E200 ; set max feed rate (mm/s)\nM204 P1000 R1000 T1000 ; set acceleration\nM205 X0 Y0 Z0 T0 ; set jerk\nG92 E0 X0 Y0 Z0 ; set position to origin\nG0 X1\nG0 X0\nG0 X3\nG0 X0\nG0 X1\nG0 X0\nG0 X3\nG0 X0\nG0 X1\nG0 X0\nM400\n\nG0 X1\nG0 X0\nM400\n", wx.DefaultPosition, wx.DefaultSize, wx.TE_DONTWRAP|wx.TE_MULTILINE )
        self.text_ctrl_test_code.SetFont( wx.Font( 9, wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Consolas" ) )

        sbSizer2.Add( self.text_ctrl_test_code, 1, wx.BOTTOM|wx.EXPAND|wx.TOP, 5 )

        bSizer11 = wx.BoxSizer( wx.HORIZONTAL )

        self.m_staticText9 = wx.StaticText( sbSizer2.GetStaticBox(), wx.ID_ANY, u"Marlin: ", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText9.Wrap( -1 )

        bSizer11.Add( self.m_staticText9, 0, wx.ALL, 0 )

        self.static_text_gcode_reference = wx.StaticText( sbSizer2.GetStaticBox(), wx.ID_ANY, u"http://marlinfw.org/meta/gcode/", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.static_text_gcode_reference.Wrap( -1 )

        self.static_text_gcode_reference.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, True, wx.EmptyString ) )
        self.static_text_gcode_reference.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_HIGHLIGHT ) )

        bSizer11.Add( self.static_text_gcode_reference, 0, wx.ALL|wx.EXPAND, 0 )
        ...
        self.m_staticText10 = wx.StaticText( sbSizer2.GetStaticBox(), wx.ID_ANY, u"Reprap: ", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText10.Wrap( -1 )

        bSizer12.Add( self.m_staticText10, 0, wx.ALL, 0 )

        self.static_text_reprap_link = wx.StaticText( sbSizer2.GetStaticBox(), wx.ID_ANY, u"https://duet3d.dozuki.com/Wiki/Gcode", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.static_text_reprap_link.Wrap( -1 )

        self.static_text_reprap_link.SetFont( wx.Font( 9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, True, "Arial" ) )
        self.static_text_reprap_link.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_HIGHLIGHT ) )
        ...
        self.m_panel41 = wx.Panel( self.m_splitter1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
        sbSizer8 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel41, wx.ID_ANY, u"Serial port monitor" ), wx.VERTICAL )

        self.rich_text_serial_log = wx.TextCtrl( sbSizer8.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_DONTWRAP|wx.TE_MULTILINE|wx.TE_READONLY|wx.TE_RICH2 )
        sbSizer8.Add( self.rich_text_serial_log, 1, wx.ALL|wx.EXPAND, 5 )

        self.rich_text_serial_log2 = wx.richtext.RichTextCtrl( sbSizer8.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_READONLY|wx.VSCROLL|wx.HSCROLL|wx.NO_BORDER|wx.WANTS_CHARS )
        ...
        self.text_ctrl_message = wx.TextCtrl( sbSizer8.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_ENTER )
        self.text_ctrl_message.SetFont( wx.Font( 9, wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Consolas" ) )

        bSizer14.Add( self.text_ctrl_message, 1, wx.ALL|wx.EXPAND, 5 )

        self.button_send = wx.Button( sbSizer8.GetStaticBox(), wx.ID_ANY, u"Send", wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT )
        ...
        self.m_splitter1.SplitVertically( self.m_panel4, self.m_panel41, 0 )
        bSizer7.Add( self.m_splitter1, 1, wx.EXPAND, 5 )


        self.panel_test_runner.SetSizer( bSizer7 )
        self.panel_test_runner.Layout()
        bSizer7.Fit( self.panel_test_runner )
        self.notebook.AddPage( self.panel_test_runner, u"Test runner", True )
        ...
        self.button_zoom_all = wx.Button( self, wx.ID_ANY, u"Zoom All", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.button_debug_2 = wx.Button( self, wx.ID_ANY, u"Interpret Old", wx.DefaultPosition, wx.DefaultSize, 0 )
        bSizer52.Add( self.button_debug_2, 0, wx.ALL, 5 )

        self.button_trim = wx.Button( self, wx.ID_ANY, u"Trim", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.Bind( wx.EVT_MENU, self.event_menu_file_open, id = self.menu_file_open.GetId() )
        self.Bind( wx.EVT_MENU, self.event_menu_file_exit, id = self.menu_file_exit.GetId() )
        self.button_run_test.Bind( wx.EVT_BUTTON, self.event_button_run_test_click )
        self.button_view_results.Bind( wx.EVT_BUTTON, self.event_button_view_results_click )
        self.button_create_update.Bind( wx.EVT_BUTTON, self.event_button_create_update_click )
        self.button_delete.Bind( wx.EVT_BUTTON, self.event_button_delete_click )
        self.combo_box_test_choice.Bind( wx.EVT_COMBOBOX, self.event_combo_selection_made )
        self.combo_box_test_choice.Bind( wx.EVT_TEXT_ENTER, self.event_combo_on_text_enter )
        self.text_ctrl_test_code.Bind( wx.EVT_CHAR, self.event_text_ctrl_test_code_char )
        self.text_ctrl_test_code.Bind( wx.EVT_TEXT, self.event_text_ctrl_test_code_on_text )
        self.static_text_gcode_reference.Bind( wx.EVT_LEFT_DOWN, self.event_static_text_gcode_reference_click )
        self.static_text_reprap_link.Bind( wx.EVT_LEFT_DOWN, self.event_static_text_reprap_reference_click )
        self.rich_text_serial_log.Bind( wx.EVT_CHAR, self.event_rich_text_serial_log_char )
        self.text_ctrl_message.Bind( wx.EVT_TEXT_ENTER, self.event_text_ctrl_message_enter )
        self.button_send.Bind( wx.EVT_BUTTON, self.event_button_send_click )
        self.button_open_test_window.Bind( wx.EVT_BUTTON, self.event_button_open_test_window_click )
        ...
        self.button_zoom_all.Bind( wx.EVT_BUTTON, self.event_button_zoom_all_click )
...
###########################################################################
## Class ObsoleteAnalysisWindowBase
###########################################################################

class ObsoleteAnalysisWindowBase ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.scroll_bar_vertical = wx.ScrollBar( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.SB_VERTICAL )
        fgSizer1.Add( self.scroll_bar_vertical, 0, wx.ALL|wx.EXPAND, 0 )

        self.scroll_bar_horizontal = wx.ScrollBar( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.SB_HORIZONTAL )
        ...
        self.static_text_data_rate = wx.StaticText( self, wx.ID_ANY, u"n/a", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL|wx.ST_NO_AUTORESIZE )
        ...
        # Connect Events
        self.Bind( wx.EVT_CLOSE, self.event_close )
        self.scroll_bar_vertical.Bind( wx.EVT_SCROLL, self.event_on_vertical_scroll )
        self.button_open_test_window.Bind( wx.EVT_BUTTON, self.event_button_open_test_window_click )
        self.button_start_stream.Bind( wx.EVT_BUTTON, self.event_button_start_stream_click )
        self.button_stop_stream.Bind( wx.EVT_BUTTON, self.event_button_stop_stream_click )
        self.button_zoom_all.Bind( wx.EVT_BUTTON, self.event_button_zoom_all_click )
...
###########################################################################
## Class ObsoleteTestWindowBase
###########################################################################

class ObsoleteTestWindowBase ( wx.Frame ):

    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Test Runner", pos = wx.DefaultPosition, size = wx.Size( 704,381 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.static_text_c3d_board_connection = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Connected on COM3", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.static_text_c3d_board_connection.Wrap( -1 )

        sbSizer1.Add( self.static_text_c3d_board_connection, 0, wx.ALL, 0 )

        self.static_text_c3d_board_data_rate = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Data rate: 1.234 Mbps", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.static_text_c3d_board_data_rate.Wrap( -1 )

        sbSizer1.Add( self.static_text_c3d_board_data_rate, 0, wx.ALL, 0 )

        self.m_staticText8 = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Data size: 200 MB", wx.DefaultPosition, wx.DefaultSize, 0 )
